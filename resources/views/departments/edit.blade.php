...
<div class="mb-4">
    <div class="d-flex align-items-center gap-2 mb-1">
        ...
        <h4 class="fw-bold mb-0" style="color:var(--text-primary)">Edit Department</h4>
    </div>
    <p class="mb-0" style="font-size:13px;color:var(--text-muted);margin-left:36px;">Update the department's details.</p>
</div>
        ...
        <form action="{{ route('departments.update', $department) }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <textarea name="description" rows="3" class="form-control form-control-sm"
                          ...
                          style="border-radius:9px;font-size:13.5px;resize:none;">{{ old('description', $department->description) }}</textarea>
            </div>
